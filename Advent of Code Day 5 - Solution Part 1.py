...
for i in range(0, len_instructions, 3):
    ...
    for j in range(0, q_moved):
        if stack_reduced == 1:
            ...
            stack_1.pop(0)
        if stack_reduced == 2:
            item_moved.insert(0, stack_2[0])
            stack_2.pop(0)
        if stack_reduced == 3:
            item_moved.insert(0, stack_3[0])
            stack_3.pop(0)
        if stack_reduced == 4:
            item_moved.insert(0, stack_4[0])
            stack_4.pop(0)
        if stack_reduced == 5:
            item_moved.insert(0, stack_5[0])
            stack_5.pop(0)
        if stack_reduced == 6:
            item_moved.insert(0, stack_6[0])
            stack_6.pop(0)
        if stack_reduced == 7:
            item_moved.insert(0, stack_7[0])
            stack_7.pop(0)
        if stack_reduced == 8:
            item_moved.insert(0, stack_8[0])
            stack_8.pop(0)
        if stack_reduced == 9:
            item_moved.insert(0, stack_9[0])
            stack_9.pop(0)
...
print("Answer Day 5, Part 1 is", stack_1[0], stack_2[0], stack_3[0],
